...
import com.example.proyecto_3_tetris_db.databinding.ActivityMainBinding
import com.example.proyecto_3_tetris_db.tetris.GameState
import com.example.proyecto_3_tetris_db.tetris.GameStateViewModel
import com.example.proyecto_3_tetris_db.R
import com.example.proyecto_3_tetris_db.tetris.parts.*
...
class MainActivity : AppCompatActivity() {
    ...
    val vm: GameStateViewModel by lazy {
        ViewModelProvider(this).get(GameStateViewModel::class.java)
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.gridboard.rowCount = ROW
        binding.gridboard.columnCount = COL

        binding.gridboardNextPart.rowCount = 2
        binding.gridboardNextPart.columnCount = 4

        var bundle: Bundle? = intent.extras

        if (bundle != null && GameState.saved) {
            // TODO aqui podria ir el guardado en BD
        ...
        initRender(boardView, binding.gridboard, ROW, COL)
        initRender(boardViewNextPart, binding.gridboardNextPart, 2, 4)
...
//    }
    ...
    fun updateScore() {
        binding.txtPoints.text = "${getResources().getString(R.string.points_label)} ${vm.points}"
    }
